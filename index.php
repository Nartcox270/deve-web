...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Neva Roleplay" />
        ...
        >
          <div class="card mb-3">
            <div class="card-body p-5 text-center">
              ...
              <h4 class="mb-0 text-white-75"> <?php echo $name ?> </h1></h4>
          ...
          <div class="btn-group w-100 text-center">
            ...
            href="<?php echo $urldiscord ?>"
          ><?php echo $Tdiscord ?></a>
            <a id="discord-link2" 
              class="d-block w-100 py-3 b-accent ml-2"
              href="fivem://connect/cfx.re/join/<?php echo $ServerURL ?>"
            ><?php echo $BJoin ?></a>
          </div>
        </div>
      </div>
